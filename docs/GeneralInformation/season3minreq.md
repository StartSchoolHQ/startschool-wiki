---
title: "Season 03 Requirements per Specialization"
description: "This document defines the **minimum required workload** for each Season 03 specialization at StartSchool."
id: "s3minreq"
---
# Minimal Season 03 Requirements per Specialization

This document defines the **minimum required workload** for each Season 03 specialization at StartSchool.

While projects differ in nature, all minimum requirements are balanced to represent a comparable level of effort and foundational competence.  
...
## Season 03 — Minimum Required Workload

### Fullstack track
| Track | Track description | Minimum required projects | Estimated hours | Project description |
| --- | --- | --- | --- | --- |
| **React** | Foundational frontend engineering with async and runtime awareness | 01 Getting Started | 5–7 | Environment setup, project structure, basic React/Next.js concepts, tooling familiarity |
|  |  | 02 Modern React Fundamentals | 10–15 | Core React concepts: components, hooks, state management, data flow, composition |
|  |  | 03 Edge Computing Streaming | 10–15 | Asynchronous data handling, streaming concepts, edge runtime thinking |
|  |  | **React — Total** | **~25–37 hrs** |  |
|  |  |  |  |  |
| **Fullstack Python** | Core programming logic and algorithmic thinking without frontend or infra complexity | python-quest01 → python-quest06 | 22–27 | Python fundamentals: syntax, variables, functions, loops, conditionals, data processing |
|  |  | my-hamming-dna | 5–7 | Algorithmic problem-solving, string comparison, logic decomposition |
|  |  | **Python — Total** | **~28–34 hrs** |  |
|  |  |  |  |  |
| **Backend** | Core backend engineering with real-world API and data management concepts | my_basecamp_2 | 12–16 | Backend fundamentals: CRUD operations, permissions, nested resources, file attachments, hosting |
|  |  | my_api | 15–20 | API design, authentication, pagination, caching, documentation, cloud deployment |
|  |  | **Backend — Total** | **~27–36 hrs** |  |
|  |  |  |  |  |
| **Fullstack Java** | Strong Java language and OOP foundation without framework-level complexity | Java Quest01 | 6–8 | Java setup, compilation, primitive types, arrays, basic methods |
|  |  | Java Quest02 | 6–8 | String handling, methods, parameters, return values |
|  |  | Java Quest03 | 8–10 | Object-oriented programming: classes, constructors, instance/static methods |
|  |  | Java Quest04 | 8–10 | Inheritance, abstract classes, interfaces, core OOP design concepts |
|  |  | **Java — Total** | **~28–36 hrs** |  |
|  |  |  |  |  |
| **Cloud Engineer** | Core cloud engineering: serverless backend + real deployment experience | My Fully Managed API | 18–22 | Serverless API development, authentication, sessions, CRUD, managed cloud services |
|  |  | My Cloud Yelp | 8–12 | Cloud deployment of an existing app, Amplify, GraphQL, authentication, debugging infra |
|  |  | **Cloud — Total** | **~26–34 hrs** |  |
